...
def ImageResultFunc(request):
    ...
    # 이미지 이동시키기
    path = "C:/Users/82108/Desktop/dataset/features/" 
    ...
    # 이미지 PNG로 저장     
    im.save('team3_views2/head/static/images/image1.jpg')
    """
    # json 파일 읽어서 DataFrame화 하기(validation)
    pd.set_option('max_columns', None)
    path = 'C:/Users/82108/Desktop/유형별 두피 이미지/validation/'
    ...
    path = "C:/Users/82108/Desktop/유형별 두피 이미지/Meta/META_DATA/" 
    ...
    print(df3.head(3))
    df3.to_csv('team3_views2/head/static/images/df3.csv', encoding='euc-kr')
    """
    df3 = pd.read_csv('team3_views2/head/static/images/df3.csv', encoding='euc-kr')
    print(df3.head(3))
    ...
    # 정규화
    img_tensor /= 255.
    model = tf.keras.models.load_model('team3_views2/head/static/images/mobile_model_62.h5')  
    
    # 모델의 예측값, 예측값에 따라 두피유형 부여(실제값 또한 나옴)
    ...
    return render(request, 'imageresult.html',{'A':b})